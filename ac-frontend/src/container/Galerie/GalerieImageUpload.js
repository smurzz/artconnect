...
function CreateImage(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        if (bildBearbeiten.title !== "") {
            requestBody.title = bildBearbeiten.title;
        }

        if (bildBearbeiten.description !== "") {
            requestBody.description = bildBearbeiten.description;
        }

        requestBody.price = bildBearbeiten.price;
        requestBody.location = bildBearbeiten.location;
