...
import '../../layout/css/home-public.css'
        ...
        !userSession ? <div className="home-public-container">
                ...
                <div className="container px-5 my-5">
                    <div className="row gx-5 align-items-center">
                        <div className="col-lg-6">
                            <img className="img-fluid rounded mb-5 mb-lg-0" alt="Pencil" src={ImagePencil}/></div>
                        <div className="col-lg-6">
            ...
            <section className="py-5 ">
                <div className="container px-5 my-5">
                    ...
                    <div className="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-6 justify-content-center">
                        ...
                        <div className="col mb-5 mb-5 mb-xl-0">
                            <div className="text-center">
                                <img className="img-fluid rounded-circle mb-4 px-2"
                                     src={Sofya} alt="Sofya Murzakova"/>
                                <h5 className="fw-bolder">Sofya Murzakova</h5>
                        ...
                        <div className="col mb-5 mb-5 mb-xl-0">
                            <div className="text-center">
                                <img className="img-fluid rounded-circle mb-4 px-2"
                                     src={Komola} alt="Komola Benzinger"/>
                                <h5 className="fw-bolder">Komola Benzinger</h5>
                                <div className="fst-italic text-muted">Software-Developer</div>
                            </div>
                        </div>
                        <div className="col mb-5 mb-5 mb-xl-0">
