...
import SocialMedias from '../components/user/SocialMedias';
import DeleteUserModel from '../components/user/DeleteUserModel';
                        ...
                        <div className="col w-100">
                            <div className="card">
                                ...
                                <div className="card-body p-4 text-black">
                                    <a as="button" class="btn btn-dark mb-3" href='/home'>Back</a>
                                        ...
                                        <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
                                            ...
                                            <div className="form-outline mb-4">
                                                ...
                                                <input
                                                    ...
                                                    onChange={async (e) => { setUser({ ...user, contacts: { ...user.contacts, telefonNumber: parseInt(e.target.value) } }); }}
                                                />
                                            </div>
                                            <div className="form-outline mb-4">
