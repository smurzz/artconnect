...
function DeleteArtworkModel(props) {
    ...
    useEffect(() => {
        if(artworkData.status === 204 && !artworkData.artwork){
            navigate('/home');
        }
    }, [dispatch, navigate, artworkData.status, artworkData.artwork])
    ...
    return (
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>Are you sure you want to delete the Artwork? This action is irreversible and will permanently delete your artwork and its images</Modal.Body>
